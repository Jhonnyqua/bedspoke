...
def create_grouped_excel(igms_csv):
    # 1) Leer llaves desde Google Sheets…
    ...
    # 4) Merge y extraer Llaves M
    merged = pd.merge(df_igms, df_keys, on="Simplified", how="left", suffixes=("_IGMS","_Key"))
    ...
    with pd.ExcelWriter(output, engine="xlsxwriter") as writer:
        ...
        band_fmt = wb.add_format({"border":1,"bg_color":"#F2F2F2","align":"left","valign":"vcenter"})
